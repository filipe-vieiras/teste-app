      ...
      <div className={`${
        ...
        <nav className="flex-1">
          <ul className="space-y-2">
            ...
            <li>
              <button
                onClick={() => setActiveMenu('business-canvas')}  // Alterado de 'feature1' para 'business-canvas'
                className={`w-full flex items-center text-white p-2 rounded-lg hover:bg-opacity-25 hover:bg-white ${
                  activeMenu === 'business-canvas' ? 'bg-white bg-opacity-10' : ''
                }`}
              >
                <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                </svg>
                Business Canvas  {/* Nome mais descritivo */}
              </button>
            </li>
